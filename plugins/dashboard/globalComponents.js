...
import BaseCheckboxLight from '~/components/argon-core/Inputs/BaseCheckboxLight.vue';
import BaseDropdown from '~/components/argon-core/BaseDropdown.vue';
import BaseHeader from '~/components/argon-core/BaseHeader';
import BaseInput from '~/components/argon-core/Inputs/BaseInput.vue';
import BaseInputLight from '~/components/argon-core/Inputs/BaseInputLight.vue';
...
Vue.component(BaseCheckboxLight.name, BaseCheckboxLight);
Vue.component(BaseHeader.name, BaseHeader);
Vue.component(BaseInput.name, BaseInput);
Vue.component(BaseInputLight.name, BaseInputLight);
